...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            new Meal(null,1,LocalDateTime.of(2017, Month.NOVEMBER, 10, 10, 0), "Завтрак", 500),
            new Meal(null,1,LocalDateTime.of(2017, Month.NOVEMBER, 10, 13, 0), "Обед", 1000),
            new Meal(null,1,LocalDateTime.of(2017, Month.NOVEMBER, 10, 20, 0), "Ужин", 500),
            new Meal(null,2,LocalDateTime.of(2017, Month.NOVEMBER, 11, 10, 0), "Завтрак", 1000),
            new Meal(null,2,LocalDateTime.of(2017, Month.NOVEMBER, 11, 13, 0), "Обед", 500),
            new Meal(null,2,LocalDateTime.of(2017, Month.NOVEMBER, 11, 20, 0), "Ужин", 510)
    );
